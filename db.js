...
const ClientActivity = sequelize.define('ClientActivity', {
  ...
  type:        { type: DataTypes.ENUM('note','call','meeting','proposal','invoice','payment','stage_change','followup'), defaultValue: 'note' },
...
module.exports = { sequelize, User, Lead, Client, ClientActivity, CallLog, Audit };
